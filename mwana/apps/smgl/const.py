...
REFERRAL_CBA_NOTIFICATION_CLINIC_WORKER = _(
    "Mother with ID: %(unique_id)s from %(village)s needs EmONC. Contact: %(phone)s. Plz send 'RESP %(unique_id)s' if you see this.")
...
RESP_THANKS = _(
    "Thanks %(name)s. Your response for referral of mother with ID: %(unique_id)s was well received")
RESP_CBA_UPDATE = _(
...
REMINDER_REFERRAL_RESP = _(
    "Please submit RESPONSE for mother with ID %(unique_id)s referred from %(from_facility)s.")
REMINDER_FU_DUE = _(
    "Mother named %(name)s with ID # %(unique_id)s is due to visit health center %(loc)s for a follow-up visit.")
REMINDER_NON_EMERGENCY_REFERRAL = _(
    "Mother named %(name)s with ID # %(unique_id)s should visit hospital %(loc)s as referred.")
REMINDER_EMERGENCY_REFERRAL = _(
    "Please submit outcome SMS (REFOUT) for mother with ID %(unique_id)s referred on %(date)s from %(loc)s")
REMINDER_UPCOMING_DELIVERY = _(
    "Mother named %(name)s with ID # %(unique_id)s is due for delivery on %(date)s please follow-up visit.")
REMINDER_PP_DUE = _(
    "Mother named %(name)s with ID # %(unique_id)s is due to visit health center %(loc)s for a postpartum visit in %(num)s days.")
REMINDER_PP_MISSED = _(
    "Mother named %(name)s with ID # %(unique_id)s is overdue to visit health center %(loc)s for a postpartum visit.")
REMINDER_SYP_TREATMENT_DUE = _(
    "This is a reminder: Mother named %(name)s should visit the health center for follow-up on %(date)s")
