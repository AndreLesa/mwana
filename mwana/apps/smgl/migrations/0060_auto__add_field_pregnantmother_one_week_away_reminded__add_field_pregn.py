...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PregnantMother.one_week_away_reminded'
        db.add_column('smgl_pregnantmother', 'one_week_away_reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PregnantMother.two_week_away_reminded'
        db.add_column('smgl_pregnantmother', 'two_week_away_reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PregnantMother.three_week_away_reminded'
        db.add_column('smgl_pregnantmother', 'three_week_away_reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PregnantMother.four_week_away_reminded'
        db.add_column('smgl_pregnantmother', 'four_week_away_reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PregnantMother.five_week_away_reminded'
        db.add_column('smgl_pregnantmother', 'five_week_away_reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PregnantMother.one_week_away_reminded'
        db.delete_column('smgl_pregnantmother', 'one_week_away_reminded')

        # Deleting field 'PregnantMother.two_week_away_reminded'
        db.delete_column('smgl_pregnantmother', 'two_week_away_reminded')

        # Deleting field 'PregnantMother.three_week_away_reminded'
        db.delete_column('smgl_pregnantmother', 'three_week_away_reminded')

        # Deleting field 'PregnantMother.four_week_away_reminded'
        db.delete_column('smgl_pregnantmother', 'four_week_away_reminded')

        # Deleting field 'PregnantMother.five_week_away_reminded'
        db.delete_column('smgl_pregnantmother', 'five_week_away_reminded')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 22, 23, 0, 34, 469078)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 22, 23, 0, 34, 468990)'}),
        ...
        'smgl.pregnantmother': {
            ...
            'five_week_away_reminded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'four_week_away_reminded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'one_week_away_reminded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'three_week_away_reminded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'two_week_away_reminded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
