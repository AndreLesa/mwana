...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('smgl_referral', 're_referral', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Past referrals', null=True, to=orm['smgl.Referral']), keep_default=False)
    ...
    models = {
        ...
        'smgl.referral': {
            ...
            'mother_uid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            're_referral': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Past referrals'", 'null': 'True', 'to': "orm['smgl.Referral']"}),
